...
public class EmployeeSkillServiceImpl implements EmployeeSkillService {
    ...
    public EmployeeSkill createEmployeeSkill(EmployeeSkill employeeSkill) {
        ...
        if (!emp.getActive()) throw new IllegalArgumentException("Cannot assign skill to inactive employee");
        if (!skill.getActive()) throw new IllegalArgumentException("Cannot assign inactive skill");
